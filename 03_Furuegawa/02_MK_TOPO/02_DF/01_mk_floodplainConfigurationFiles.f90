...
fname='output/targetArea_inDF.asc'
write(ctmp,*)iend
...
fname='output/elevation_inDF.asc'
f_fmt='(*(f10.3)))'
...
close(10)
!
open(10,file='output/fluxPoint_eBoudary_inDF.txt')
write(10,*)n_ij_u_e
write(10,'(a)')'x,y,i,j'
do k=1,n_ij_u_e
  i=ij_u_e(k,1)
...
close(10)
!
open(10,file='output/fluxPoint_sBoudary_inDF.txt')
write(10,*)n_ij_v_s
write(10,'(a)')'x,y,i,j'
do k=1,n_ij_v_s
  i=ij_v_s(k,1)
...
close(10)
!
open(10,file='output/fluxPoint_nBoudary_inDF.txt')
write(10,*)n_ij_v_n
write(10,'(a)')'x,y,i,j'
do k=1,n_ij_v_n
  i=ij_v_n(k,1)

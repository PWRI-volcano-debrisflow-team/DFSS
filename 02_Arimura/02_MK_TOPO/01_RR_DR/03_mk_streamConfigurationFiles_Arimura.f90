...
read(1,*)
!
fname='output/elevation_inRR.asc'
...
! sw s se ! 5  6  7
nirs=0
open(20,file='misc/river_bounds.txt')
write(20,*)'x,y,i,j'
do i=1,iend
  do j=1,jend
...
do k=1,nirs
  ...
  read(20,*)x,y,iriver_sta_i(k),iriver_sta_j(k) !,nirs_dirflag(k)
  if(x/=-32205.d0 .or. y/=-157845.d0)cycle
...
!
open(20,file='output/streamConfiguration_inRR.txt')
...
close(20)
!
open(20,file='misc/streamConfiguration_Checker.txt')

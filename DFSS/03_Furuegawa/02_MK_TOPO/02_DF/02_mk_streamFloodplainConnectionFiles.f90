...
!
open(1,file='output/controlVolume_centerPoint_inDF.txt')
read(1,*)n_ij_cv
...
close(1)
!
open(1,file='output/fluxPoint_x_inDF.txt')
read(1,*)n_ij_u
...
close(1)
!
open(1,file='output/fluxPoint_y_inDF.txt')
read(1,*)n_ij_v
...
ij_1d2d(:,:,:)=0
write(*,*)'# of div. =',itr
open(20,file='output/streamFloodplainConnection.txt')
